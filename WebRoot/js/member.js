...
function checkLogin(t){	
	...
	if(userMail==""||userMail==null){
		...
		$.ajax({  
            ...
            success:function(data){            	
            	if(data.flag==true){                		
            		 $('.alert').html('���Ѿ����͹����������ˣ���ȴ��Է��ظ���').addClass('alert-success').show().delay(1500).fadeOut();  
            	}
            	else{
            		$.ajax({  
                        ...
                        success:function(data){
                        	if(data.flag==true){                        		
                        		 $('.alert').html('�ѳɹ����ͺ������룡').addClass('alert-success').show().delay(1500).fadeOut();  
                        	}
                        	else{
                        		 $('.alert').html('����ʧ�ܣ�').addClass('alert-success').show().delay(1500).fadeOut();  
                        	}
                        }
                    })
            	}

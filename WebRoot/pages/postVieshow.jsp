			                     ...
			                     <ul id="postpagefoot" class="pager">	                     	                     	
				                     ...
				                     <c:forEach var="pageNum" begin="1" end="${postBean.totalPage}">
				                     	<c:choose>
				                     		...
				                     		<c:otherwise>
				                     			<li><a onclick="pagingViePost(this)" href="javascript:void(0);" name="showViePostByPage?page=${pageNum}">${pageNum}</a></li>
				                     		</c:otherwise>		                     		                     			                     
				                     	</c:choose>		                     			                     		                     	
				                     </c:forEach>
				                     <c:choose>
			                     		...
			                     		<c:otherwise>
			                     			<li><a onclick="pagingViePost(this)" href="javascript:void(0);" name="showViePostByPage?page=${pageBean.currentPage+1}">&raquo;</a></li>			                     		
			                     		</c:otherwise>
			                     	</c:choose>	                        		                      	   
								</ul>										 
		                    </s:else>	                	                                
